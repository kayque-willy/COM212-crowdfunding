    ...
    <div id="main" class="container-fluid">
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center">Realizar login</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-offset-3 col-md-6">
                        ...
                        <?php } ?>
                        <form action="<?php echo base_url('/usuario/login')?>" role="form" method="POST">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="input" class="btn btn-md btn-primary center-block">Entrar</button>
                            </div>
                        </form>
                    </div>
                </div>
