...
class Projeto_model extends CI_Model{
  ...
  public function insert(){
    //Cria um vetor de valores para atualização
     ...
     if(isset($this->prazoMaximo)) $data['prazoMaximo']=$this->prazoMaximo;
     if(isset($this->valorMaximo)) $data['valorMaximo']=$this->valorMaximo;
     if(isset($this->valorMinimo)) $data['valorMinimo']=$this->valorMinimo;
